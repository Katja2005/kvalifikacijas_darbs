<x-guest-layout>
    <x-authentication-card>
        <x-slot name="logo">
            <img src="{{ asset('images/logo.png')}}" alt="Baltic Breeze Hotel" class="w-32 h-auto mx-auto">
        </x-slot>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div>
                <x-label for="phone" value="{{ __('Telefona numurs') }}" />
            ...
            <div class="mt-4">
                <x-label for="password_confirmation" value="{{ __('Apstipriniet paroli') }}" />
